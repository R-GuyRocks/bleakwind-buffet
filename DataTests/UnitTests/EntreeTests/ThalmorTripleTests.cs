...
namespace BleakwindBuffet.DataTests.UnitTests.EntreeTests
{
    public class ThalmorTripleTests
    {
        ...
        {
            DoubleDraugr tt = new DoubleDraugr();
            tt.Mayo = true;
            Assert.True(tt.Mayo);
            tt.Mayo = false;
                                                                    ...
                                                                    bool includeBacon, bool includeEgg)
        {
            ...
            if (includeBun && includeMustard && includePickle && includeCheese && includeTomato && includeLettuce && includeMayo && includeBacon && includeEgg) Assert.Empty(tt.SpecialInstructions);
        }
